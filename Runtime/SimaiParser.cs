                                ...
                                if (fumen[i..].Length >= 4) // <HS*x>
                                {
                                    ...
                                    try
                                    {
                                        ...
                                        if (!isInvalid) // min: HS*1
                                        {
                                            ...
                                            else throw new InvalidSimaiSyntaxException(Ycount, Xcount, Content.ToString(), "Unexpected HS / SV declaration syntax, is it \"HS\" or \"SV\"?");
                                        }
